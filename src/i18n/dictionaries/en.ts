...
export const en = {
  ...
  employer: {
    ...
    jobForm: {
      ...
      descriptionPlaceholder: "Role overview, team, impact…",
      requirements: "Requirements",
      requirementsPlaceholder: "Must-have skills, years of experience…",
      ...
      country: "Country",
      select: "Select",
      salaryMin: "Salary min (EUR)",
      salaryMax: "Salary max (EUR)",
      currency: "Currency",
      skills: "Skills (comma-separated)",
      skillsPlaceholder: "React, TypeScript, Node.js",
      languages: "Languages (comma-separated)",
      languagesPlaceholder: "English, French, Arabic",
      whatShouldWeDo: "What should we do?",
      hintCreate:
        "Save as draft to finish later, or post to publish on the job board.",
      hintEditDraft: "Save your edits, post to go live, or keep as draft.",
      hintEditPublished:
        "Save changes, close hiring, or move back to draft.",
      hintEditClosed: "Save changes or reopen the job on the board.",
      saving: "Saving…",
      posting: "Posting…",
      ...
      draftsHintBefore: "Drafts are only visible to you. Posted jobs appear on",
      draftsHintAfter: ".",
    },
    jobStatuses: {
      draft: "Draft",
    ...
    onboardingPage: {
      metadataTitle: "Company setup",
      title: "Set up your company",
      subtitle:
        "Before you start hiring, tell us your company name and website.",
      mistakeHint:
        "Signed up by mistake? You can leave and browse the site, or sign out and create a candidate account instead.",
    ...
    candidateFilters: {
      title: "Search talent",
      search: "Search",
      searchPlaceholder: "Name, headline, skills, bio…",
      country: "Country",
      allMena: "All MENA countries",
      skill: "Skill",
      anySkill: "Any skill",
      language: "Language",
      anyLanguage: "Any language",
      cvOnly: "CV uploaded only",
      searching: "Searching…",
      clear: "Clear",
    },
    menaCountries: {
    ...
    applicationActions: {
      ...
      messageFallback: "candidate",
      messagingUnlock: "Messaging unlocks after you accept this application.",
    },
    applicationStatuses: {
      pending: "Pending",
      accepted: "Accepted",
    ...
    newJobPage: {
      title: "New job post",
      description:
        "Draft a role and publish when you're ready for candidates to see it.",
      back: "Back to job posts",
      sectionTitle: "Job details",
      sectionDesc: "Published jobs appear on /jobs for all visitors.",
    },
    editJobPage: {
      title: "Edit job post",
      createdBanner:
        "Job saved as Draft. Set status to Published below and click Save — or use Publish to job board on the job posts list — so candidates see it at /jobs.",
      back: "Back to job posts",
      sectionTitle: "Job details",
      sectionDesc: "Changes save immediately. Published jobs are visible at /jobs.",
      metadataTitle: "Edit job",
    },
    actionMessages: {
      somethingWrong: "Something went wrong.",
      titleRequired: "Title and description are required.",
      jobNotFound: "Job not found.",
      jobLive: "Job is live on the job board.",
      jobClosed: "Job marked as closed.",
      jobDraft: "Job moved to draft.",
      jobSaved: "Job saved.",
      jobUpdated: "Job updated.",
      jobNowLive: "Job is now live on the job board.",
      jobClosedShort: "Job closed.",
      noPostCredits:
        "No post credits available. Buy a single post to publish.",
      onboardingMustSignIn: "You must be signed in as an employer.",
      ...
      acceptBeforeMessage:
        "Accept this application before messaging the candidate.",
    },
    billing: {
      title: "Billing",
