...
export const fr: Messages = {
  ...
  employer: {
    ...
    jobForm: {
      ...
      jobTitleRequired: "Intitulé du poste *",
      jobTitlePlaceholder: "ex. Développeur React senior",
      descriptionRequired: "Description *",
      descriptionPlaceholder: "Aperçu du poste, équipe, impact…",
      requirements: "Exigences",
      requirementsPlaceholder: "Compétences requises, années d'expérience…",
      employmentType: "Type d'emploi",
      workStyle: "Mode de travail",
      experience: "Expérience",
      city: "Ville",
      cityPlaceholder: "Paris, Berlin…",
      country: "Pays",
      select: "Sélectionner",
      salaryMin: "Salaire min (EUR)",
      salaryMax: "Salaire max (EUR)",
      currency: "Devise",
      ...
      whatShouldWeDo: "Que souhaitez-vous faire ?",
      hintCreate:
        "Enregistrez en brouillon pour finir plus tard, ou publiez sur le site d'offres.",
      hintEditDraft:
        "Enregistrez vos modifications, publiez pour mettre en ligne ou gardez en brouillon.",
      hintEditPublished:
        "Enregistrez, fermez le recrutement ou repassez en brouillon.",
      hintEditClosed:
        "Enregistrez les modifications ou rouvrez l'offre sur le site.",
      saving: "Enregistrement…",
      posting: "Publication…",
      saveAsDraft: "Enregistrer en brouillon",
      postJob: "Publier l'offre",
      saveChanges: "Enregistrer",
      moveToDraft: "Passer en brouillon",
      markClosed: "Marquer comme fermée",
      reopenPost: "Rouvrir et publier",
      draftsHintBefore:
        "Les brouillons ne sont visibles que par vous. Les offres publiées apparaissent sur",
      draftsHintAfter: ".",
    },
    jobStatuses: {
      draft: "Brouillon",
    ...
    onboardingForm: {
      ...
      websitePlaceholder: "https://votreentreprise.com",
      websiteHint:
        "Votre site public. Les candidats peuvent consulter ce lien.",
      saving: "Enregistrement…",
      continue: "Continuer vers le tableau de bord",
    },
    onboardingPage: {
      metadataTitle: "Configuration entreprise",
      title: "Configurez votre entreprise",
      subtitle:
        "Avant de commencer à recruter, indiquez le nom et le site web de votre entreprise.",
      mistakeHint:
        "Inscription par erreur ? Parcourez le site ou déconnectez-vous pour créer un compte candidat.",
    ...
    candidateFilters: {
      ...
      search: "Rechercher",
      searchPlaceholder: "Nom, titre, compétences, bio…",
      country: "Pays",
      allMena: "Tous les pays MENA",
      skill: "Compétence",
      anySkill: "Toute compétence",
      language: "Langue",
      anyLanguage: "Toute langue",
      cvOnly: "CV téléversé uniquement",
      searching: "Recherche…",
      clear: "Effacer",
    },
    menaCountries: {
    ...
    applicationActions: {
      ...
      messageFallback: "candidat",
      messagingUnlock:
        "Les messages s'activent après avoir accepté cette candidature.",
    },
    applicationStatuses: {
      pending: "En attente",
      accepted: "Acceptée",
    ...
    deleteJob: {
      confirm: "Supprimer « {title} » ? Action irréversible.",
    ...
    newJobPage: {
      ...
      description:
        "Préparez une offre et publiez-la quand vous êtes prêt pour les candidats.",
      back: "Retour aux offres",
      sectionTitle: "Détails de l'offre",
      sectionDesc: "Les offres publiées apparaissent sur /jobs pour tous les visiteurs.",
    },
    editJobPage: {
      title: "Modifier l'offre",
      createdBanner:
        "Offre enregistrée en brouillon. Passez le statut à Publiée ci-dessous et enregistrez — ou publiez depuis la liste des offres — pour que les candidats la voient sur /jobs.",
      back: "Retour aux offres",
      sectionTitle: "Détails de l'offre",
      sectionDesc:
        "Les modifications sont enregistrées immédiatement. Les offres publiées sont visibles sur /jobs.",
      metadataTitle: "Modifier l'offre",
    },
    actionMessages: {
      somethingWrong: "Une erreur s'est produite.",
      titleRequired: "L'intitulé et la description sont requis.",
      jobNotFound: "Offre introuvable.",
      jobLive: "L'offre est en ligne sur le site d'emploi.",
      jobClosed: "Offre marquée comme fermée.",
      jobDraft: "Offre passée en brouillon.",
      jobSaved: "Offre enregistrée.",
      jobUpdated: "Offre mise à jour.",
      jobNowLive: "L'offre est maintenant en ligne.",
      jobClosedShort: "Offre fermée.",
      noPostCredits:
        "Aucun crédit de publication. Achetez une publication pour publier.",
      onboardingMustSignIn: "Vous devez être connecté en tant qu'employeur.",
      onboardingCompanyRequired: "Le nom de l'entreprise est requis.",
      onboardingInvalidWebsite:
        "Entrez une URL valide (ex. votreentreprise.com).",
      unauthorized: "Non autorisé.",
      invalidStatus: "Statut invalide.",
      applicationNotFound: "Candidature introuvable.",
      applicationAccepted: "Candidature acceptée.",
      applicationDeclined: "Candidature refusée.",
      acceptBeforeMessage:
        "Acceptez cette candidature avant de contacter le candidat.",
    },
    billing: {
      title: "Facturation",
